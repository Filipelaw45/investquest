...
export const TradesList = ({ trades }: { trades: Trade[] }) => {
        ...
        {trades.map((trade) => (
          <div key={trade.id} className='bg-white shadow-md rounded-lg p-4 border border-gray-200'>
            <div className='flex justify-between items-center'>
              ...
              <span
                className={`px-2 py-1 rounded-full text-sm font-medium ${
                  trade.profitOrLoss > 0 ? 'bg-green-100 text-green-600' : 'bg-red-100 text-red-600'
                }`}
              >
            ...
            <div className='text-sm text-gray-600'>
              ...
              <p>
                <strong>Preço de venda:</strong> ${trade.sellPrice.toFixed(2)}
              </p>
              <p>
